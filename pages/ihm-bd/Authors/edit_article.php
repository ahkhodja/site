                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-10">
                                ...
                                <textarea  name="keyword" class="form-control" id="text" placeholder ="Keywords should be separated by semicolons, e.g. electroceramics; metallic ; ceramics. *"><?php echo "".$row['keywords'].""; ?></textarea>
