...
<div class="h_left">
					<ul>
      	  				<li><a href="editor_home.php"><h2>Home</h2></a></li>
...
<div id="forme">
<h2 class="div-title">List of submitted paper</h2>
</div>
<div id="forme">
<table  width=100% border="1" cellpadding="0" cellspacing="0" id="tableau" style="max-width: 1024px;">
        <thead>
          <tr>
          <th>Title</th>
            <th>Author</th>         
	  ...
	  while($row = $select->fetch_assoc()){
		  ...
		  <td> '. $row2['title'].'</td>
			...
			<td><a href="../Authors/files/'.$row2['author'].'/'. $row3['url'].'">download</a></td>
