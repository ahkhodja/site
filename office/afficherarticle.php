...
<input type="hidden" value="<?php echo $_GET['etat'];?>" id="etat"/>
 <?php
...
?> 
 ...
 <input class="submit action-button" style=" float:right;"  type="submit" value="Validate" name="submit" id="submit2">
 </div>
 <div id="refused"> <input class="submit action-button" style=" float:right;"  type="submit" value="Validate" name="submit" id="submit3"></div>
</fieldset>
